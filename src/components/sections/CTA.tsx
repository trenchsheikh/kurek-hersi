...
export function CTA() {
  ...
  return (
    <section id="conversation" className="relative pt-24 md:pt-40 pb-12 bg-black w-full flex justify-center overflow-hidden">
      ...
      <div className="container px-4 md:px-6 mx-auto max-w-5xl relative z-10 text-center">
        <FadeIn>
          ...
          <h2 className="font-serif text-3xl md:text-5xl lg:text-6xl font-medium mb-10 md:mb-12 leading-[1.1] tracking-tight text-white max-w-4xl mx-auto">
            No pitch. No obligation.
          </h2>
          
          <p className="text-lg md:text-2xl font-sans font-light text-white/60 max-w-2xl mx-auto leading-relaxed tracking-tight mb-12 md:mb-16">
